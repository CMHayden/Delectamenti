...
<div class = "wrapper" id="wrapper">
  ...
  <div class = "display">
    Please fill out the form bellow to create your account:<br/><br />
    <form name="login" method="post" action="register.php">
      ...
      <input type="password" id="confirm_passwd" name="confirm_passwd" placeholder="Repeat your password..."></input>
      <br />
      ...
      <br />
      <input type="checkbox" name="vegetarian" value="true">Vegetarian<br />
